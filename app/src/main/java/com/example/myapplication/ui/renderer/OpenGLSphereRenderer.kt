 ...
 */
class OpenGLSphereRenderer : GLSurfaceView.Renderer, OpenGLRenderer {
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        Matrix.setRotateM(mRotationMatrix, 0, 180f, 0f, 1f, 0f)
    ...
    override fun checkGlError(operation: String) {
        ...
        if (error != GLES32.GL_NO_ERROR) {
            Timber.e("OpenGLSphereRenderer error %s operation %s", error, operation)
        }
    }
